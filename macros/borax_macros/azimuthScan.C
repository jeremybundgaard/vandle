...
void azimuthScan(const int preamp, const char *actinide, const int phiLoopMin,
                 const int phiLoopMax, const int phiLoopStep) {
  ...
  if (preamp == 1) {
    if (!(strcmp(actinide, "cf"))) {
      sprintf(noMaskFileName, "$trees/trkTreeDir/cfTrees/cfNoMask1.trees.root");
      sprintf(cftFileName, "$trees/trkTreeDir/cfTrees/cfCFT1.trees.root");
      sprintf(noMaskRunCut,
              "100001850 > run && run > 100001856 && run !=100001870");
      sprintf(noMaskCut, " %s && %s ", fitCut, noMaskRunCut);
      sprintf(cftCut, "%s", fitCut);
    }
    if (!(strcmp(actinide, "cm"))) {
      sprintf(noMaskFileName, "$trees/trkTreeDir/cmTrees/cmNoMask1.trees.root");
      sprintf(cftFileName, "$trees/trkTreeDir/cmTrees/cmCFT1.trees.root");
  ...
  if (preamp == 2) {
    if (!(strcmp(actinide, "cf"))) {
      sprintf(noMaskFileName, "$trees/trkTreeDir/cfTrees/cfNoMask2.trees.root");
      sprintf(cftFileName, "$trees/trkTreeDir/cfTrees/cfCFT2.trees.root");
      sprintf(noMaskCut, "%s", fitCut);
      sprintf(cftCut, "%s", fitCut);
    }
    if (!(strcmp(actinide, "cm"))) {
      sprintf(noMaskFileName, "$trees/trkTreeDir/cmTrees/cmNoMask2.trees.root");
      sprintf(cftFileName, "$trees/trkTreeDir/cmTrees/cmCFT2.trees.root");
      sprintf(noMaskCut, "%s", fitCut);
      sprintf(cftCut, "%s", fitCut);
    }
  ...
  cout << "noMaskFileName = " << noMaskFileName << endl;
  cout << "cftFileName = " << cftFileName << endl;
  ...
  double radPhiMin = 0, radPhiMax = 0, piLessradPhiMin = 0, piLessradPhiMax = 0,
         origin = 0;
  int degPhiMin = 0, degPhiMax = 0;
  char charContainer[123];
  char cftPhiCut[234];
  char noMaskPhiCut[234];
  ...
  for (int phi = phiLoopMin; phi < phiLoopMax; phi += phiLoopStep) {
    ...
    phiCut << radPhiMin - TMath::Pi()
           << " < direction.Phi() && direction.Phi() < "
           << radPhiMax - TMath::Pi();

    sprintf(noMaskPhiCut, "%s && %s", phiCut.str().c_str(), noMaskCut);
    sprintf(cftPhiCut, "%s && %s", phiCut.str().c_str(), cftCut);

    std::cout << phiCut.str().c_str() << std::endl;

    sprintf(charContainer, "noMaskLvEnPhiMin%03i", degPhiMin);
    TH2D *noMaskLvEn =
        new TH2D("noMaskLvEn", charContainer, 40000, 0, 168.6, 1000, 0, 10);

    sprintf(charContainer, "cftLvEnPhiMin%03i", degPhiMin);
    TH2D *cftLvEn =
        new TH2D("cftLvEn", charContainer, 40000, 0, 168.6, 1000, 0, 10);
    ...
    cftLvEn->SetTitle(cftPhiCut);
    cftTracks->Draw("length:adc*168.6/40000>>cftLvEn", cftPhiCut);
    ...
    noMaskLvEn->SetTitle(noMaskPhiCut);
    noMaskTracks->Draw("length:adc*168.6/40000>>noMaskLvEn", noMaskPhiCut);

    TH1D *noMaskFrags =
        noMaskLvEn->ProjectionX("noMaskFrags", 0, 40000, "[fragCut]");
    ...
    double scaleCFT =
        noMaskFrags->Integral(5000, 40000) / cftFrags->Integral(5000, 40000);
    ...
    double noMask_aSF_ratio =
        2 * noMaskNotFragIntegral / (double)noMaskFragIntegral;
    double cft_aSF_ratio = 2 * cftNotFragIntegral / (double)cftFragIntegral;
    char cftFragChar[123], noMaskFragChar[123], noMask_aSF_ratioChar[123],
        cft_aSF_ratioChar[123], noMaskNotFragCutChar[123],
        cftNotFragCutChar[123], cftEffChar[123];
    sprintf(cftEffChar, "fragRatio = %.3f",
            noMaskFragIntegral / (double)cftFragIntegral);
    ...
    sprintf(noMaskNotFragCutChar, "noMaskNotFragIntegral = %d",
    ...
    ///////////////////////////////////////////////////////////////////
    double origin = 0.5;
    TLine *lMin = new TLine(origin, origin,
                            0.5 * TMath::Cos(radPhiMin - TMath::Pi()) + origin,
                            0.5 * TMath::Sin(radPhiMin - TMath::Pi()) + origin);
    lMin->SetLineColor(3);
    lMin->SetLineWidth(2);
    TLine *lMax = new TLine(origin, origin,
                            0.5 * TMath::Cos(radPhiMax - TMath::Pi()) + origin,
                            0.5 * TMath::Sin(radPhiMax - TMath::Pi()) + origin);
    lMax->SetLineColor(3);
    lMax->SetLineWidth(2);
    ...
    TLatex *t0deg =
        new TLatex(2 * origin - 0.1, origin - 0.1, "#scale[2]{0^{o}}");
    TLatex *t90deg =
        new TLatex(origin - 0.1, 2 * origin - 0.1, "#scale[2]{90^{o}}");
    ...
    sprintf(charContainer, "frags.full.log.cft.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    ...
    fragCountText.DrawTextNDC(0.15, 0.86, noMaskFragChar);
    fragCountText.DrawTextNDC(0.15, 0.89, cftFragChar);
    sprintf(charContainer, "frags.full.log.noMask.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    fragCountText.DrawTextNDC(0.15, 0.86, noMaskFragChar);
    fragCountText.DrawTextNDC(0.15, 0.89, cftFragChar);
    sprintf(charContainer, "frags.full.lin.cft.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    fragCountText.DrawTextNDC(0.15, 0.86, noMaskFragChar);
    fragCountText.DrawTextNDC(0.15, 0.89, cftFragChar);
    sprintf(charContainer, "frags.lowEn.cft.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    fragCountText.DrawTextNDC(0.15, 0.86, noMaskFragChar);
    fragCountText.DrawTextNDC(0.15, 0.89, cftFragChar);
    sprintf(charContainer, "frags.full.lin.noMask.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    fragCountText.DrawTextNDC(0.15, 0.86, noMaskFragChar);
    fragCountText.DrawTextNDC(0.15, 0.89, cftFragChar);
    sprintf(charContainer, "frags.lowEn.noMask.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    TH1D *cftFragsScaleRegion =
        (TH1D *)scaledCftFrags->Clone("cftFragsScaleRegion");
    for (int i = 0; i < 5000; ++i)
      cftFragsScaleRegion->SetBinContent(i, 0);
    ...
    t270deg->Draw("same");
    c1->cd();
    sprintf(charContainer, "bothFragsCut.logxy.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    cftFragsScaleRegion->Draw("same");
    sprintf(charContainer,
            "bothFragsCut.logxy.showScalingRegion.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    t270deg->Draw("same");
    c1->cd();
    sprintf(charContainer, "bothFragsCut.lin.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    cftFragsScaleRegion->Draw("same");
    sprintf(charContainer,
            "bothFragsCut.lin.showScalingRegion.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    t270deg->Draw("same");
    c1->cd();
    sprintf(charContainer, "cftEfficiency.phiMin%03i.phiMax%03i.png", degPhiMin,
            degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    t270deg->Draw("same");
    c1->cd();
    sprintf(charContainer, "cftEfficiencyWithFrags.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    fragCountText.DrawTextNDC(0.15, 0.86, noMaskFragChar);
    fragCountText.DrawTextNDC(0.15, 0.89, cftFragChar);
    sprintf(charContainer, "cftEfficiency.lowEn.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    fragCountText.DrawTextNDC(0.15, 0.86, noMaskFragChar);
    fragCountText.DrawTextNDC(0.15, 0.89, cftFragChar);
    sprintf(charContainer, "bothFragsCut.zoom.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    t270deg->Draw("same");
    c1->cd();
    sprintf(charContainer, "cftLvEn.full.log.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    cftLvEn->GetYaxis()->SetRangeUser(0, 7);
    sprintf(charContainer, "cftLvEn.full.log.zoom.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    t270deg->Draw("same");
    c1->cd();
    sprintf(charContainer, "cftLvEn.full.lin.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    fragCut->Draw("same");
    ...
    sprintf(charContainer,
            "cftLvEn.full.lin.plusFragCut.phiMin%03i.phiMax%03i.png", degPhiMin,
            degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    t270deg->Draw("same");
    c1->cd();
    sprintf(charContainer, "cftLvEn.lowEn.phiMin%03i.phiMax%03i.png", degPhiMin,
            degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    fragCut->Draw("same");
    ...
    sprintf(charContainer,
            "cftLvEn.lowEn.plusFragCut.phiMin%03i.phiMax%03i.png", degPhiMin,
            degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    t270deg->Draw("same");
    c1->cd();
    sprintf(charContainer, "noMaskLvEn.full.log.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    sprintf(charContainer, "noMaskLvEn.full.log.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    ...
    sprintf(charContainer, "noMaskLvEn.full.log.zoom.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    c1->SetLogx(0);
    sprintf(charContainer, "noMaskLvEn.full.lin.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    noMaskLvEn->Draw("Colz");
    TPad *inset_pad10 =
        new TPad("inset_pad10", "inset_pad10", 0.7, 0.6, 0.9, 0.9);
    ...
    t270deg->Draw("same");
    c1->cd();
    sprintf(charContainer, "noMaskLvEn.full.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    fragCut->Draw("same");
    ...
    sprintf(charContainer,
            "noMaskLvEn.full.lin.plusFragCut.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    ...
    noMaskLvEn->Draw("Colz");
    TPad *inset_pad11 =
        new TPad("inset_pad11", "inset_pad11", 0.7, 0.6, 0.9, 0.9);
    ...
    t270deg->Draw("same");
    c1->cd();
    sprintf(charContainer, "noMaskLvEn.lowEn.phiMin%03i.phiMax%03i.png",
            degPhiMin, degPhiMax);
    c1->SaveAs(charContainer, "recreate");
    fragCut->Draw("same");
    ...
    sprintf(charContainer,
            "noMaskLvEn.lowEn.plusFragCut.phiMin%03i.phiMax%03i.png", degPhiMin,
            degPhiMax);
    c1->SaveAs(charContainer, "recreate");
