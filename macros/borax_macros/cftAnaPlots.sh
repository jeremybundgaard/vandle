...
topdir=`pwd`/cftAnaPlots.${actinide}.${preamp}preamp.driftVel${driftVel}.`date +%d%b%y_%H%M.%S`
mkdir $topdir
cd $topdir
cp $macros/cftAnaPlots.{sh,C} $topdir

echo root -l -q -b cftAnaPlots.C\($preamp,\"$actinide\"\,\"$pidFile\"\,\"$noMaskTree\"\,\"$cftTree\"\,\"$cuts\"\,\"$driftVel\"\,\"$addGuide\"\)
time root -l -q -b cftAnaPlots.C\($preamp,\"$actinide\"\,\"$pidFile\"\,\"$noMaskTree\"\,\"$cftTree\"\,\"$cuts\"\,\"$driftVel\"\,\"$addGuide\"\)
wait
...
//////////////////////////
gm montage -mode concatenate -tile 2x2 \
noMaskCuts.asf.fullEn.logxy.png noMaskCuts.asf.lowEn.png \
cf252.preamp${preamp}.noMaskEn.fullEn.logxy.png cf252.preamp${preamp}.noMaskEn.lowEn.logy.png \
cf252_2x2grid_asf_lowEn.png
wait
echo "created cft.2x2grid.asf.lowEn.logx.png"
//////////////////////////
gm montage -mode concatenate -tile 2x2 \
noMaskLvEn.cuts.fullEn.logx.png noMaskLvEn.cuts.lowEn.png \
noMask_pidCuts_En_Stack_logxy_fullEn.png noMask_pidCuts_En_Stack_logy_lowEn.png \
cf252_2x2grid_asf_PID_bins.png
//////////////////////////
...
gm montage -mode concatenate -tile 2x4 \
noMaskLvEn_noCuts.png noMaskLvEn_wCuts.png \
Energy_vs_Azimuth_noCuts.png Energy_vs_Azimuth_wCuts.png \
Length_vs_cosTheta_noCuts.png Length_vs_cosTheta_wCuts.png \
Energy_vs_cosTheta_noCuts.png Energy_vs_cosTheta_wCuts.png \
4x2grid.with_and_wo_aziumth_cut.png
wait
echo "created 4x2grid.with_and_wo_aziumth_cut.png"

gm montage -mode concatenate -tile 2x2 \
noMaskLvEn_noCuts.png Length_vs_cosTheta_noCuts.png  \
Energy_vs_Azimuth_noCuts.png Energy_vs_cosTheta_noCuts.png  \
2x2grid.noCuts.png
wait
echo "created 2x2grid.noCuts.png"

gm montage -mode concatenate -tile 2x2 \
noMaskLvEn_wCuts.png Length_vs_cosTheta_wCuts.png  \
Energy_vs_Azimuth_wCuts.png Energy_vs_cosTheta_wCuts.png  \
2x2grid.wCuts.png
wait
echo "created 2x2grid.wCuts.png"
