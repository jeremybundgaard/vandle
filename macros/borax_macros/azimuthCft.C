...
void vertexCft(const int preamp, const char* actinide, const char* noMaskFileName="", const char* cftFileName="", const char* otherTreeCuts="1",const char* pidType="") {
...
if (preamp==1)
{
	...
	if (!(strcmp(pidType,"zCut"))){
		sprintf(pidFile_char,"$cft/pid/pidCut_zCut%d.root",preamp);
