...
dst->SetBranchAddress("vandle_bar",&vandle_bar);
...
dst->SetBranchAddress("dataRun",&dataRun);
               ...
               const char* cutChar_local)
{
  ...
  dst_local->Draw("vandle_QDC:vandle_TOF>>QDCvsTOF",cutChar_local,"colz");
  ...
  dst_local->Draw("vandle_TOF>>NEUTRON_TOF",buffChar_local,"");
  ...
  dst_local->Draw("vandle_TOF",buffChar_local,"same");
  sprintf(NEUTRON_TOF_char,"%s_vandleTOF_Neutrons.png",isotope_local);
  c1->SaveAs(NEUTRON_TOF_char);

  sprintf(buffChar_local,"%s&&%s",tcutg_BACKGROUND_local->GetName(),cutChar_local);
  dst_local->Draw("(vandle_TOF-400)>>neutron_BACKGROUND",buffChar_local,"");
  ...
  dst_local->Draw("vandle_bar:vandle_TDiff>>BarvsTDiff",cutChar_local,"colz");
  ...
  dst_local->Draw("vandle_QDC:vandle_bar>>BarvsQDC",cutChar_local,"colz");
  ...
  dst_local->Draw("vandle_bar:vandle_TDiff>>BarvsTDiff_zoom",cutChar_local,"colz");
  ...
  dst_local->Draw("vandle_bar:vandle_TOF>>BarvsTOF",cutChar_local,"colz");
