...
int main(int argc, char *argv[]){
	...
	handler.addOption(optionExt("dir", required_argument, NULL, 'd', "<path>", "Specify the top-level directory (default=./)"));
	handler.addOption(optionExt("verbose", no_argument, NULL, 'V', "", "Enable verbose output"));
