...
if(PAASS_DIR)
	...
	if(EXISTS ${PAASS_DIR}/lib)
		...
		if(EXISTS "${PAASS_LIBRARY_DIR}/libPaassScan.so")
			set(PAASS_LIB_SCAN "${PAASS_LIBRARY_DIR}/libPaassScan.so" CACHE Path "Paass scan library shared object.")
		endif()
	endif()
endif()
